  ...
  return (
    <div className="w-full px-4 lg:px-0">
      <div className="w-full">
        <div className="bg-white rounded-t-[32px] w-full px-8 pt-4 pb-2">
          ...
          <h4 className="text-[16px] 2xl:text-[18px] font-[400] leading-[22px] mt-[30px] md:mt-[30px] text-[#44464A] mx-auto text-center w-4/5 mb-8">
