...
const Modal = ({
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-full ">
      ...
      <div className="modal-content bg-white w-4/5 lg:w-max md:px-20 rounded-20 mx-auto z-50 px-6 py-4">
        <h2 className="text-[#080808] text-sm text-center mb-6">{question}</h2>
