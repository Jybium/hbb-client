        ...
        <div className="lg:w-[36%] bg-profile p-[1rem] rounded-lg backdrop-blur-sm overflow-y-auto">
          <div className="flex items-center justify-between ">
            <div className="relative">
              ...
              <Camera
                className="p-2 bg-white absolute -left-0 bottom-0 text-base2 rounded-full"
                color="#E688A3"
                size={35}
              />
            </div>
          ...
          <div className="bg-black w-full h-[2rem] my-[1rem] rounded-lg"></div>

          <div>
            <div className="flex justify-between items-center">
              <p>Info</p>
              <Button
                className="flex gap-1 border h-[2rem] border-white rounded-lg py-1 lg:py-[2px] px-3 bg-transparent"
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 py-[0.75rem]">
                    <p className="px-3 py-1 h-[2rem] text-center w-fit content-center grid bg-base rounded-full text-xs">
                      Walking dog
                    </p>
                    <p className="px-3 py-1 h-[2rem] text-center w-fit content-center grid bg-base rounded-full text-xs">
                      Walking dog
                                  ...
                                  <SelectContent className="w-fit bg-base top-0 max-h-20 overflow-y-auto drop-shadow-md">
                                    <ScrollArea className="absolute max-h-20 overflow-y-auto scroll">
                                      ...
                                      <ScrollBar
                                        ...
                                        className="bg-placeholderText scroll"
                                      />
                                    </ScrollArea>
                                  </SelectContent>
                                </Select>
                                ...
                                >
                                  ...
                                  <SelectContent className="w-full bg-base absolute top-0 max-h-20 overflow-y-auto">
                                    <ScrollArea className="absolute max-h-20 overflow-y-auto scroll">
                                      ...
                                      <SelectItem value="GB|🇬🇧">
                                        🇬🇧 +44sjkjkkkkkkkkkkerrrrrrr
                                      </SelectItem>
                                      <SelectItem value="CA|🇨🇦">
                                        🇨🇦 +1 hsdjjjjjsdddsderrrrrere
                                      </SelectItem>
                                      <SelectItem value="CA|🇨🇦">
                                        🇨🇦 +1 dssssdsdsddsdseerreeree
                                      </SelectItem>
                                      <ScrollBar
                                        orientation="vertical"
                                        className="bg-placeholderText scroll"
